...
const api = {
  ...
  applyProviderProfile: (id: string): Promise<import('../main/profiles').ProfileResult> => {
    return ipcRenderer.invoke('profiles:apply', id)
  },
  deleteProviderProfile: (id: string): Promise<import('../main/profiles').ProfileResult> => {
